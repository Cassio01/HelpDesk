...
public class TicketServiceImpl implements TicketService{
	...
	public Page<Ticket> findByParameterAndAssingedUser(int page, int count, String title, String status,
		...
		Pageable pages = new PageRequest(page, count);
		return this.ticketRepository.findByTitleIgnoreCaseContainingAndStatusAndPriorityAndAssingedUserIdOrderByDateDesc(title, status, priority, assingnedUser, pages);
	}
