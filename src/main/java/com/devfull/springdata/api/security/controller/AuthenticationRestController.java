package com.devfull.springdata.api.security.controller;
...
import com.devfull.springdata.api.security.jwt.JwtAuthenticationRequest;
import com.devfull.springdata.api.security.jwt.JwtTokenUtil;
import com.devfull.springdata.api.security.model.CurrentUser;
...
public class AuthenticationRestController {
	...
	public ResponseEntity<?> refreshTokenAndGetAuthenticationToken(HttpServletRequest request){
		String token = request.getHeader("Authorization");
		String username = jwtTokenUtil.getUserNameFromToken(token);
		final User usuario = usuarioService.findByEmail(username);
		
		if(jwtTokenUtil.canTokenRefreshed(token)) {
